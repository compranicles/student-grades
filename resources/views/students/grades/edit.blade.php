                ...
                <div class="card-body">
                    <form action="{{ route('student.grade.store') }}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="grade" type="number" class="form-control @error('grade') is-invalid @enderror" name="grade" value="{{ old('grade', $grade) }}" required autocomplete="grade" autofocus>
                                <small>Grades must be from 0 - 100</small>
                                @error('grade')
